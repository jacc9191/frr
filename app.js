...
if (botonVerDescripcion && descripcionTexto) {
  ...
  // Ocultar botón si la descripción está vacía
...
function inicializarCarruselInteractivo(producto) {
  ...
  // ✅ Corrección clave: tomamos el precio desde el atributo seguro
  const precioAttr = producto.querySelector('.precio-producto').getAttribute("data-precio");
  const precio = parseInt(precioAttr);
